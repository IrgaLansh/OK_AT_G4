...
public class CreateMassivClass {

    public void myCreateMassivClass() {


        int[] massiv = new int[7];
        Random random = new Random();

        System.out.println("CreateRndMassivClass");
        System.out.print("CreateRndMassiv ");
        for (int i = 0; i < massiv.length; i++) {massiv[i] = random.nextInt(20);
            System.out.print(massiv[i] + " ");}
        System.out.println();

        System.out.print("Backward Massiv ");
        ...
        System.out.print("KvadratMassiv ");
        for (int i = 0; i < massiv.length; i++) {
